...
const MainPage = () => {
  ...
  return !isPlayerShown ? (
    <React.Fragment>
      ...
      <h2 className="mb-5 lg">🕵🏻‍🕵🏻‍♂🕵🏻‍♂️🕵🏻‍♂️🕵🕵🏻‍♂️🕵🏻‍♂️🕵🏻‍♂️🕵🏻🕵🏻‍♂️</h2>
      <hr className="mb-5" />
      ...
      <p>
        {" "}
        RULES OF THE GAME: "Everyone will be shown one word (exact same word),
        except the SPY. Its a game where you have a spy who doesnt know the
        secret word. You go one by one & tell sth close (synonym) to the secret
        word. The spy should try to figure out the word.Players vote and if
        people figure out who is spy, spy will have last chance to tell the
        word. If spy gives correct word, spy is the winner, otherwise people
        win. <br /> GOOD LUCK, SPY"
      </p>
    </React.Fragment>
  ) : (
    <PlayersPage
